...
type Props = {
  wheelTexturesURLs: string[];
  deckTexturesURLs: string[];
}

export default function Preview({wheelTexturesURLs, deckTexturesURLs}: Props) {


  const {selectedWheel, selectedBolt, selectedTruck, selectedDeck} = useCustomizerControls()
  ...
  return (
    <Canvas camera={{position: [2.5, 1, 0], fov: 50 }} shadows>
      <Suspense fallback={null}>
        ...
        <Skateboard
          wheelTextureURLS={wheelTexturesURLs}
          wheelTextureURL={wheelTextureURL}
          deckTextureURLs={deckTexturesURLs}
